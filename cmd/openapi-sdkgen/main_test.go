...
func TestGenerateWritesTypeScriptSourceTree(t *testing.T) {
	...
	for _, expected := range []string{"index.ts", "metadata.ts", "internal/schemas/index.ts", "internal/schemas/wire.ts", "internal/client.ts", "internal/errors.ts", "internal/index.ts", "internal/runtime/errors.ts", "internal/runtime/http.ts"} {
