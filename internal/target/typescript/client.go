...
func emitClient(document *ir.Document, manifest Manifest, links []generatedLink, streams []generatedStream) ([]byte, error) {
	...
	output.WriteString("export type RouteInput<Route extends keyof Routes> = PublicType<RouteContract<Route>[\"input\"]>\n\n")
	output.WriteString("/** Generated input remaining after resource path binding for one exact route. */\n")
	output.WriteString("export type RouteResourceInput<Route extends keyof Routes> = PublicType<RouteContract<Route>[\"resourceInput\"]>\n\n")
	output.WriteString("/** Per-request transport options for one exact route. */\n")
	output.WriteString("export type RouteOptions<Route extends keyof Routes> = PublicType<RouteContract<Route>[\"options\"]>\n\n")
	output.WriteString("/** Decoded successful output for one exact route. */\n")
	output.WriteString("export type RouteOutput<Route extends keyof Routes> = PublicType<RouteContract<Route>[\"output\"]>\n\n")
	output.WriteString("/** Successful raw response union for one exact route. */\n")
	output.WriteString("export type RouteRawResponse<Route extends keyof Routes> = PublicType<RouteContract<Route>[\"rawResponse\"]>\n\n")
	...
	output.WriteString("export type StreamCall<Route extends keyof Routes> = RouteContract<Route>[\"stream\"] & RouteTypeIdentity<Route>\n\n")
	output.WriteString("/** Pagination operation call for one exact route. */\n")
	output.WriteString("export type PaginateCall<Route extends keyof Routes> = RouteContract<Route>[\"pagination\"] & RouteTypeIdentity<Route>\n\n")
	output.WriteString("/** Response-link calls for one exact route. */\n")
	output.WriteString("export type LinkCalls<Route extends keyof Routes> = RouteContract<Route>[\"links\"] & RouteTypeIdentity<Route>\n\n")
