...
func TestEmitMetadataPreservesDocumentationExamplesAndExtensions(t *testing.T) {
	...
	for _, expected := range []string{
		...
		`["parent", "api"]`,
		`["kind", "navigation"]`,
		`["externalDocs", Object.fromEntries([["url", "https://example.test/docs"]])]`,
		`["x-root", Object.fromEntries([["preserved", true]])]`,
		`["x-path", Object.fromEntries([["preserved", true]])]`,
		`["x-operation", Object.fromEntries([["preserved", true]])]`,
		`["x-parameter", Object.fromEntries([["preserved", true]])]`,
		`["x-schema", Object.fromEntries([["preserved", true]])]`,
		`["summary", "List widgets"]`,
		`["description", "Lists every widget."]`,
		...
		`["description", "Widget response"]`,
		`["summary", "Widget response"]`,
		`["dataValue", Object.fromEntries([["id", "1"]])]`,
		`["serializedValue", "{\"id\":\"1\"}"]`,
		`["examples", Object.fromEntries([["widget", Object.fromEntries([["value", Object.fromEntries([["id", "1"]])]])]])]`,
