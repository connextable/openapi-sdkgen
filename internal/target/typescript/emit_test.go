...
func TestSourceArtifactsGenerateNestedResourceTree(t *testing.T) {
	...
	for _, expected := range []string{
		...
		`export type RouteInput<Route extends keyof Routes> = PublicType<RouteContract<Route>["input"]>`,
		`export type RouteResourceInput<Route extends keyof Routes> = PublicType<RouteContract<Route>["resourceInput"]>`,
		`export type RouteOptions<Route extends keyof Routes> = PublicType<RouteContract<Route>["options"]>`,
		`export type RouteOutput<Route extends keyof Routes> = PublicType<RouteContract<Route>["output"]>`,
		`export type RouteRawResponse<Route extends keyof Routes> = PublicType<RouteContract<Route>["rawResponse"]>`,
