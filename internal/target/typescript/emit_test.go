...
func TestSourceArtifactsGenerateNestedResourceTree(t *testing.T) {
	...
	for _, expected := range []string{
		...
		`export type RouteInput<Route extends keyof Routes> = RouteContract<Route>["input"]`,
		`export type RouteResourceInput<Route extends keyof Routes> = RouteContract<Route>["resourceInput"]`,
		`export type RouteOptions<Route extends keyof Routes> = RouteContract<Route>["options"]`,
		`export type RouteOutput<Route extends keyof Routes> = RouteContract<Route>["output"]`,
		`export type RouteRawResponse<Route extends keyof Routes> = RouteContract<Route>["rawResponse"]`,
		...
		`export type ResourceCall<Route extends keyof Routes> = RouteContract<Route>["resourceCall"] & RouteTypeIdentity<Route> & OperationTypeIdentity<Route, "resource">`,
		...
		`export type OperationInput<Source extends OperationSource> = OperationContract<Source>["input"]`,
		`export type OperationOutput<Source extends OperationSource> = OperationContract<Source>["output"]`,
